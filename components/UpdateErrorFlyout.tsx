...
interface UpdateErrorFlyoutProps {
  message: string;
  onClose: () => void;
}

const UpdateErrorFlyout: React.FC<UpdateErrorFlyoutProps> = ({ message, onClose }) => {
    return (
        <div className="fixed inset-0 bg-black/70 z-[90] flex items-center justify-center animate-fade-in" onClick={onClose}>
            <div className="bg-gray-800 rounded-lg shadow-xl w-full max-w-md border border-amber-500/50" onClick={e => e.stopPropagation()}>
                <div className="p-4 border-b border-gray-700 bg-amber-900/20 flex items-center space-x-3">
                    ...
                    <h2 className="text-xl font-bold text-amber-400">Update Notice</h2>
                </div>
                <div className="p-6">
...
export default UpdateErrorFlyout;
