...
import { Instructor, Trainee, SyllabusItemDetail, EventLimits, PhraseBank, MasterCurrency, CurrencyRequirement } from '../types';
        ...
        <div className="flex-1 flex overflow-hidden bg-gray-900">
            ...
            <div className="flex-1 overflow-y-auto bg-gray-900">
                <div className="p-6">
                    ...
                    <SettingsView {...props} activeSection={activeSection} />
                </div>
            </div>
        </div>
    );
