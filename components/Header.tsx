        ...
        <>
            <header className="bg-gray-800 h-16 flex-shrink-0 flex items-center justify-between px-4 z-20">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    >
                        <img src="/icons/multi-select-icon.png" alt="Multi-select mode" style={{ height: '20px', width: '20px', display: 'block' }} />
                    </button>
                    <button
                    ...
                    >
                        <img src="/icons/warning-icon.png" alt="Validation mode" style={{ height: '20px', width: '20px', display: 'block' }} />
                    </button>
