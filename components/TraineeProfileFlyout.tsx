                    ...
                    <div className="flex-1 flex flex-row overflow-hidden">
                        ...
                        <div className="flex-1 p-6 space-y-4 overflow-y-auto">
                            ...
                            {isEditing ? (
                                ...
                                <>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4"><InfoRow label="Rank" value={rank} /><InfoRow label="Callsign" value={`${callsignData?.callsignPrefix || ''}${callsignData?.callsignNumber || ''}`} /></div>
